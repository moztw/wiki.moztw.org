...
Барылы көрүөххүн сөп. Быһаарыы баҕар [{{fullurl:{{#Special:Log}}/suppress|page={{FULLPAGENAMEE}}}} кистээһин сурунаалыгар] баара буолуо.",
...
Ол да буоллар [$1 барылы көрүөххүн сөп].",
...
Баҕардаххына [$1 барыллар уратыларын] син биир көрүөххүн сөп.",
'rev-deleted-diff-view' => "Барыллартан биирдэстэрэ '''сотуллубут'''.
Ол да буоллар тэҥнээн көрүөххүн сөп. Сиһилии манна [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} сотуу сурунаалыгар] баар буолуон сөп.",
'rev-suppressed-diff-view' => "Барыллартан биирдэстэрэ '''кистэммит'''.
Ол да буоллар тэҥнээн көрүөххүн сөп. Сиһилии манна [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} кистээһин сурунаалыгар] баар буолуон сөп.",
...
'yourvariant' => 'Иһинээҕитин тылын барыла:',
'prefs-help-variant' => 'Биики сирэйдэрин иһинээҕитин ханнык тылынан эбэтэр таба суруйуу барылынан көрүөххүн баҕараҕыный.',
...
'filename-toolong' => 'Билэ аата 240 баайты аһарыа суохтаах.',
'badfilename' => 'Билэ аата маннык буолла: "$1".',
'filetype-mime-mismatch' => '«.$1» билэ кэтирээһинэ MIME-көрүҥэр ($2) сөп түбэспэт.',
...
'filetype-banned-type' => '\'\'\'".$1"\'\'\' — {{PLURAL:$4|билэ бобуллубут көрүҥэ|билэ бобуллубут көрүҥнэрэ}}..
...
'minutes-abbrev' => '$1м.',
'hours-abbrev' => '$1ч.',
'seconds' => '{{PLURAL:$1|$1 сөкүүндэ|$1 сөкүүндэ}}',
...
'logentry-newusers-newusers' => '$1 кыттааччыны бэлиэтээбит',
'logentry-newusers-create' => '$1 кыттааччыны бэлиэтээбит',
